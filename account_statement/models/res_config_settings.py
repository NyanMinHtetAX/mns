...
class ResConfigSettings(models.TransientModel):
    ...
    def get_values(self):
        ...
        res.update({
            'statement_days': int(
                self.env['ir.config_parameter'].sudo().get_param('account_statement.statement_days')) or None,
    ...
    def set_values(self):
        ...
        if self.send_statement and self.period != 'weekly':
            statement_cron = self.env['ir.model.data'].xmlid_to_object(
                'account_statement.autometic_send_statement_cron')
