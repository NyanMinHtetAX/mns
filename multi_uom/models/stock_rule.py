...
class StockRule(models.Model):
    ...
    # Changing _update_purchase_order_line method and delete the seller because it was null and having error so
    # change to like original module of function by ETK
