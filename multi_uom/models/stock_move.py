...
class StockMove(models.Model):
    ...
    product_uom_qty = fields.Float(compute='convert_to_product_uom_qty', inverse='convert_to_multi_uom_qty', store=True)
