...
class ResPartner(models.Model):
    ...
    partner_credit = fields.Monetary(compute='credit_debit_get',string='Total Receivable Amt', help="Total amount this customer owes you.")
    partner_debit = fields.Monetary(compute='credit_debit_get',string='Total Payable Amt',help="Total amount you have to pay to this vendor.")
