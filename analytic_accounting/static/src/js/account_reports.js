odoo.define('analytic_accounting.account_report', function (require) {
'use strict';
...
//            console.log(this.M2MFilters,'MMMMM FILTER LIST ')
//            if (!this.M2MFilters) {
//                var fields = {};
...
//        }
        if (this.report_options.partner) {
                ...
                console.log('PARTNER BBBBBB AAAAA', this);
                var fields = {};
                if ('partner_ids' in this.report_options) {
                    fields['partner_ids'] = {
                        label: _t('Partners'),
...
//            if (!this.M2MFilters) {
                console.log('ANALYTIC AAAAA', this);
                var fields = {};
