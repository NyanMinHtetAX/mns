...
class ProductImages(models.Model):
    ...
    jr_config_id = fields.Many2one('jr.config', string='JR')
    ...
    def create(self, vals_list):
        ...
        return super().create(normal_vals) + super(ProductImages, context_without_template).create(variant_vals_list)
