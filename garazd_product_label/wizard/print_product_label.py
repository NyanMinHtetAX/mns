...
class PrintProductLabel(models.TransientModel):
    ...
    template = fields.Selection(
        ...
        ('garazd_product_label.report_product_label_A5_without_price','Without Price(A5)'),
        ('garazd_product_label.report_product_label_custom', 'Label Custom size(3 pics on 1 row)')],
